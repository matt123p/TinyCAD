...
{
  return !( (m_point_a.x-ERRORSIZE<left && m_point_a.x+ERRORSIZE<=left) || (m_point_a.x-ERRORSIZE>right && m_point_a.x+ERRORSIZE>=right)
        || (m_point_a.y-ERRORSIZE<top && m_point_a.y+ERRORSIZE<=top) || (m_point_a.y-ERRORSIZE>bottom && m_point_a.y+ERRORSIZE>=bottom));
}
