...
: public CDocResource
{
	...
	public:	static const CString	DEFAULT_FONT;

	//-- The sizes of fonts
	//-- font height for normal text
	public:	static const Int32 		TEXT_HEIGHT;

	//-- font height for ruler text
	public:	static const Int32 		RULE_HEIGHT;

	//-- font height for pin text
	public:	static const Int32 		PIN_HEIGHT;

	// The Font this describes
	private:		LOGFONT			m_oFont;

	//=====================================================================
	//== ctor/dtor/initializing                                          ==
	//=====================================================================
	public:						ListOfFonts();
	public:						ListOfFonts( const ListOfFonts& );
	public:						ListOfFonts( LOGFONT f );
	public:						ListOfFonts( Int32 nHeight, bool bIsItalic );
	public:	virtual				~ListOfFonts();
	public:			void		Init();
	public:			void		Init( LOGFONT  );

	//=====================================================================
	//== accessor/mutator                                                ==
	//=====================================================================
	//-- Get the data associated with this resource
	public:			LOGFONT 	GetFont() const;
	public:			LOGFONT&	GetFontRef();
	public:			LOGFONT*	GetFontPtr();
	public: static 	LOGFONT		GetDefaultFont();

	//=====================================================================
	//== serialization                                                   ==
	//=====================================================================
	public:	virtual	void		ReadNative( CStream& oStream );
	public:	virtual	void		Read( CXMLReader& xml, hFONT& nID );
	public:	virtual	void		Write( CXMLWriter& xml ) const;

	public:	virtual void		LoadItem( CTinyCadDoc* pDesign, CStream&, hRESOURCE );
	public:	virtual	void		SaveItemXML( CTinyCadDoc *pDesign, CXMLWriter& xml );
