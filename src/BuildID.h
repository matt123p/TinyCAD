...
//
#define SVN_WCREV _T("183")		//Highest committed revision number
#define SVN_WCDATE _T("2009/02/22 11:48:33")	//Date of highest committed revision
#define SVN_WCRANGE _T("186:187")	//Update revision range
#define SVN_WCURL _T("https://tinycad.svn.sourceforge.net/svnroot/tinycad/TinyCAD/trunk")		//Repository URL of the working copy
#define SVN_WCNOW _T("2009/02/24 14:22:09")		//Current system date and time
...
#define SVN_MIXED SVN_MIXED_REVISIONS_PRESENT
