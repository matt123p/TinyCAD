...
class CAutoSave
{
	...
	//== class constants                                                 ==
	//=====================================================================
	private: static const int	M_NID;

	//=====================================================================
	//== class variables                                                 ==
	//=====================================================================
	//-- Time in minutes between autosave events
	private: static	UInt32		m_nDelay;

	//-- Singleton
	private: static CAutoSave*	m_pInstance;
	...
	private: static CAutoSave*	GetInstance();
