...
public:
	CDlgFindBox(CWnd *pParentWnd) : CDialog( IDD_FIND, pParentWnd ) { }
...
public:
	CDlgPageSizeBox(CWnd *pParentWnd, CPoint CurrentSize) : CDialog( IDD_PAGESIZE, pParentWnd )
		{ Size = CurrentSize; }
