...
: public CDocResource
{
	...
	private:		LineStyle	m_oStyle;

	//=====================================================================
	//== ctor/dtor/initializing                                          ==
	//=====================================================================
	public: 					ListOfStyles();
	public: 					ListOfStyles( const ListOfStyles& oStyle );
	public: 					ListOfStyles( LineStyle s );
	public: 					ListOfStyles( Int32 nStyle, Int32 nThickness, COLORREF crLine );
	public: virtual 			~ListOfStyles();
	private:		void		Init();
	private:		void		Init( Int32 nStyle, Int32 nThickness, COLORREF crLine );

	//=====================================================================
	//== accessor/mutator                                                ==
	//=====================================================================
	//-- Get the data associated with this resource
	public: 		LineStyle* 	GetLineStylePtr();

	//=====================================================================
	//== serialization                                                   ==
	//=====================================================================
	public:	virtual	void		ReadNative( CStream& oStream );
	public:	virtual	void		Read( CXMLReader& xml, hSTYLE& nID );
